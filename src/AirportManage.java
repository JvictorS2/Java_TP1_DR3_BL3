...
public class AirportManage {
    ...
    static void Main() {
        ...
        do
        {
            ...
            ArquivoCsv csvCliente = new ArquivoCsv("TP1_Java","Cliente","csv","src\\Data\\cliente.csv");
            ArquivoCsv csvPassagem = new ArquivoCsv("TP1_Java","Passagem","csv","src\\Data\\passagem.csv");
